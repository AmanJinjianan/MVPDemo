...
public class CodingDetailFragment2 extends Fragment {
    View mView;

    public Activity context1;
    public Handler theHandler;
    private MyViewPager myViewPager;
    public CodingDetailFragment2(MyViewPager mp){
        myViewPager = mp;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        if(mView == null){
            mView = inflater.inflate(R.layout.fragment_codingdetail2,null);
        }
        return mView;
    }
